...
public class Task4 {
    public static void main(String[] args) {
        ...
        // CLEAN THE STRING: 
        // 1. Convert to lowercase so 'R' and 'r' match
        // 2. Remove anything that isn't a letter or number (spaces, punctuation)
        String cleanedInput = originalInput.toLowerCase().replaceAll("[^a-zA-Z0-9]", "");
